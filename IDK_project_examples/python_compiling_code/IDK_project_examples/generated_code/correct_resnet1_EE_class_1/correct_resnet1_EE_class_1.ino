/*
 * Auto-generated Arduino runner: correct_resnet1_EE_class_1
 *
 * Copy this file and all files from the generated code directory
 * into a single Arduino sketch folder named "correct_resnet1_EE_class_1".
 * (Folder name must match the .ino filename.)
 *
 * Board: Arduino Giga R1  (FQBN: arduino:mbed_giga:giga)
 *
 * Compile check (no upload):
 *   arduino-cli compile --fqbn arduino:mbed_giga:giga correct_resnet1_EE_class_1/
 *
 * Model I/O:
