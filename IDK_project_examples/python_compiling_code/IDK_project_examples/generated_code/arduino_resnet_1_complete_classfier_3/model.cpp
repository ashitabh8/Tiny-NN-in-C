...
void model_forward(const float* input, float* output) {
    ...
    _t_start = micros();
    static float slot_0[16384];
    static float slot_1[16384];
    static float slot_2[16384];
    ...
    conv2d_nhwc(slot_1, 7, 256, 2, stage0_block2_conv1_weight, 3, 3, 2, NULL, 1, 1, 1, slot_0);
    // stage0_block2_bn1 [batchnorm]
    batchnorm2d_nhwc(slot_0, 7, 256, 2, stage0_block2_bn1_gamma, stage0_block2_bn1_beta, stage0_block2_bn1_mean, stage0_block2_bn1_var, 1e-05f, slot_2);
    // stage0_block2_relu1 [relu]
    relu(slot_2, 3584);
    // stage0_block2_conv2 [conv2d]
    conv2d_nhwc(slot_2, 7, 256, 2, stage0_block2_conv2_weight, 3, 3, 2, NULL, 1, 1, 1, slot_0);
    // stage0_block2_bn2 [batchnorm]
    batchnorm2d_nhwc(slot_0, 7, 256, 2, stage0_block2_bn2_gamma, stage0_block2_bn2_beta, stage0_block2_bn2_mean, stage0_block2_bn2_var, 1e-05f, slot_2);
    // add_2 [add]
    for (int i = 0; i < 3584; ++i) {
        slot_0[i] = slot_2[i] + slot_1[i];
    }
    ...
    conv2d_nhwc(slot_0, 7, 256, 2, stage0_block3_conv1_weight, 3, 3, 2, NULL, 1, 1, 1, slot_1);
    // stage0_block3_bn1 [batchnorm]
    batchnorm2d_nhwc(slot_1, 7, 256, 2, stage0_block3_bn1_gamma, stage0_block3_bn1_beta, stage0_block3_bn1_mean, stage0_block3_bn1_var, 1e-05f, slot_2);
    // stage0_block3_relu1 [relu]
    relu(slot_2, 3584);
    // stage0_block3_conv2 [conv2d]
    conv2d_nhwc(slot_2, 7, 256, 2, stage0_block3_conv2_weight, 3, 3, 2, NULL, 1, 1, 1, slot_1);
    // stage0_block3_bn2 [batchnorm]
    batchnorm2d_nhwc(slot_1, 7, 256, 2, stage0_block3_bn2_gamma, stage0_block3_bn2_beta, stage0_block3_bn2_mean, stage0_block3_bn2_var, 1e-05f, slot_2);
    // add_3 [add]
    for (int i = 0; i < 3584; ++i) {
        slot_1[i] = slot_2[i] + slot_0[i];
    }
    ...
    conv2d_nhwc(slot_1, 7, 256, 6, stage2_block0_shortcut_conv_weight, 1, 1, 32, NULL, 2, 2, 0, slot_0);
    ...
    conv2d_nhwc(slot_1, 7, 256, 6, stage2_block0_conv1_weight, 3, 3, 32, NULL, 2, 2, 1, slot_0);
