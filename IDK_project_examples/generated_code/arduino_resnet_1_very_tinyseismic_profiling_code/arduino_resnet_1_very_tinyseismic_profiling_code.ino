/*
 * Auto-generated Arduino runner: arduino_resnet_1_very_tinyseismic_profiling_code
 *
 * Copy this file and all files from the generated code directory
 * into a single Arduino sketch folder named "arduino_resnet_1_very_tinyseismic_profiling_code".
 * (Folder name must match the .ino filename.)
 *
 * Board: Arduino Giga R1  (FQBN: arduino:mbed_giga:giga)
 *
 * Compile check (no upload):
 *   arduino-cli compile --fqbn arduino:mbed_giga:giga arduino_resnet_1_very_tinyseismic_profiling_code/
 *
 * Model I/O:
 *   Input  (NCHW): [1, 4, 7, 256]  ->  NHWC flat: 7168 floats
...
// Buffer sizes
// ---------------------------------------------------------------------------
#define INPUT_SIZE  7168   // 1 * 7 * 256 * 4  (NHWC)
